...
// const exercise1Result1 = const exercise1Result1 = exercise1Array.map(person => person.name);

// Your solution here (regular arrow function): const exercise1Result2 = exercise1Array.map(function(person
// const exercise1Result2 = const exercise1Result2 = exercise1Array.map(function(person) {
//   return person.name;
// });
...
// Your solution here (one-line arrow function):
// const exercise2Result1 = const exercise2Result1 = exercise2Array.map(num => `${num} dollars`);
...
// Your solution here (one-line arrow function):
// const exercise3Result1 = conjst exercise3Result1 = exercise3Array.map(color => `<div>${color}</div>`);

// Your solution here (regular arrow function):
// const exercise3Result2 = const exercise3Result2 = exercise3Array.map(function(color) {
...
// Your solution here (one-line arrow function):
// const exercise4Result1 = const exercise4Result1 = exercise4Array.map(num => num * num + 10);

// Your solution here (regular arrow function):
// const exercise4Result2 = const exercise4Result2 = exercise4Array.map(function(num) {
//   return num * num + 10;
// });
...
// Your solution here (one-line arrow function):
// const exercise5Result1 = const exercise5Result1 = exercise5Array.map(fruit => fruit.split('').reverse().join(''));

// Your solution here (regular arrow function):
// const exercise5Result2 = const exercise5Result2 = exercise5Array.map(function(fruit) {
